...
public class ChatManager {
    ...
    public ChatManager(FFAPlugin plugin) { this.plugin = plugin; }
    ...
    public String formatChat(Player player, String message) {
        ...
        return plugin.getConfig().getString("chat.format", "{tier} §f{player} §7» §f{message}")
